...
In talking with our other peers also working on topic modelling and in conjunction with our findings above, we have observed that our dictionary (it can be noted even that this was the case even before we filtered extremes) was extremely small in comparison to the amount of data points that we had.
